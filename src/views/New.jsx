...
export default function New() {
  ...
  return (
    <div>
      ...
      {/* ITERATION 4 */}
      {/* Should display a form to create a new tv show and then redirect (navigate) to the detail of the show created */}
      <form onSubmit={handleSubmit}>
        ...
        <textarea rows="5" cols="50" name="description" value={newShow.description} onChange={handleChange} />
